...
`data/ieee30.m` is the standard IEEE 30-bus test case, distributed with
...
the 40.2% blackout threshold (Scenario 1) follow:
...
system-function script (`sfun_dcopt.py`, `func_dcopt_py.py`, `run_case30.py`)
were prepared by the authors of Byun et al. (2024) and mirrored here from the
TSUM demo repository (`tsum/demos/case30`).
