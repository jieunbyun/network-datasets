...
`data/ieee57.m` is the standard IEEE 57-bus test case, distributed with
...
the 54.1% blackout threshold (Scenario 1) follow:
...
system-function script (`sfun_dcopt.py`, `func_dcopt_py.py`, `run_case57.py`)
were prepared by the authors of Byun et al. (2024) and mirrored here from the
TSUM demo repository (`tsum/demos/case57`).
