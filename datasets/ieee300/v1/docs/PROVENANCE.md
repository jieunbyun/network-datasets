...
`data/ieee300.m` is the standard IEEE 300-bus test case, distributed with
...
the 26.1% blackout threshold (Scenario 1) follow:
...
system-function script (`sfun_dcopt.py`, `func_dcopt_py.py`, `run_case300.py`)
were prepared by the authors of Byun et al. (2024) and mirrored here from the
TSUM demo repository (`tsum/demos/case300`).
